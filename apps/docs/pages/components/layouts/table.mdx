  ...
  properties={[
    {
      ...
      default: "",
      required: false,
      description: "A react component that add additional content when the row is expanded. By passing this prop, the row will be expandable.",
    },
    {
      ...
      required: false,
      description: "Set the icon to use when the expandable rows are collapsed.",
    },
    {
    ...
    },
    {
      ...
      default: "48px",
      required: false,
      description: "Set minimum height for each row.",
    },
  ]}
/>
