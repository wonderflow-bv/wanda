...
export default ({ children }) => (
  <MdxLayout
    title="Animations"
    description="Motion provides meaning"
  >
    {children}
  </MdxLayout>
);
...
Although [our four motion principles](/design/motion/overview) are always valid, it is appropriate to make a distinction between two different styles of animations:
