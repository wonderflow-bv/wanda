...
There is no way to handle these animations by using only CSS. To create advanced animations using this mechanic, you must rely on advanced animation frameworks like Framer Motion (used on Wanda) or Gsap.
