...
```bash
npm i @wonderflow/react-components @wonderflow/themes @wonderflow/icons
...
<Snackbar>
  <Markdown>
  Due to a [limitation of postcss-import](https://github.com/postcss/postcss-import/issues/480#issuecomment-1018071406), if you are going to import the themes from within css, you have to specify the path to the file, which is
  `@wonderflow/themes/dist/themes.css`.
  </Markdown>
</Snackbar>
