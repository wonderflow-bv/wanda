...
Although [our four motion principles](/documentation/usage/design/motion/principles) are always valid, it is appropriate to make a distinction between two different styles of animations:
