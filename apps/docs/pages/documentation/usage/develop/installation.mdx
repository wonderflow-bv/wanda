...
Wanda's core elements are formed by [tokens](/documentation/usage/develop/design-tokens), [react-components](https://github.com/wonderflow-bv/react-components) and the [shared configurations](https://github.com/wonderflow-bv/config/).
