...
<Snackbar kind="info" title="Learn more">Learn more about [themes](/get-started/documentation/design/themes) and [how to use them](/get-started/documentation/develop/using-themes)</Snackbar>
