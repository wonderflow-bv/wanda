  ...
  <MarkdownToJsx
    options={{
      overrides: {
        ...
        pre: { component: Code },
        h1: { component: Components.Title, props: { level: '2', as: 'h1' } },
        h2: { component: Components.Title, props: { level: '3', as: 'h2' } },
        h3: { component: Components.Title, props: { level: '4', as: 'h3' } },
        h4: { component: Components.Title, props: { level: '5', as: 'h4' } },
        h5: { component: Components.Title, props: { level: '6', as: 'h5' } },
