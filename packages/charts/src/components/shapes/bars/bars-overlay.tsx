          ...
          return (
            <Group key={_.uniqueId()} top={barGroup.y0}>
              {sortedBars.map((bar) => {
                ...
                const { x, y, width } = getBarSizeAndPosition(bar, overlayAxis, thickness, isHorizontal);
        ...
        return (
          <Group key={_.uniqueId()} left={barGroup.x0}>
            {sortedBars.map((bar) => {
              ...
              const { x, y, height } = getBarSizeAndPosition(bar, overlayAxis, thickness, isHorizontal);
